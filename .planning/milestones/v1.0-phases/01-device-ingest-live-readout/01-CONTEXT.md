...
- `hardware/SEPCARE-HARDWARE-SOT.md` — canonical S3-Tiny hardware/schema: GPIO 6/7 I²C, GPIO 4 DS18B20 1-Wire, periodic WiFi summaries, 600mAh battery/power safety, and firmware bring-up constraints
- `hardware/parts-list.md` — current hardware BOM (moved from the repository root)
